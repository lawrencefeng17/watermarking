...
plots_dir = '/home/lawrence/prc/plots_original/'
os.makedirs(plots_dir, exist_ok=True)

# Process the dataset and get the statistics DataFrame
df_statistics = process_dataset(data_dir, output_csv='/home/lawrence/prc/token_statistics_original.csv')